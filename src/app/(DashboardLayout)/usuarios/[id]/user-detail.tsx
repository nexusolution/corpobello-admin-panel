...
function IdentityCard({ user, t }: { user: AppUser; t: TFn }) {
  ...
  return (
    <div className='relative rounded-lg border border-border dark:border-darkborder bg-card overflow-hidden'>
      ...
      <div className='h-28 bg-gradient-to-r from-lightprimary via-lightsuccess/60 to-lightprimary' />
      ...
      <div className='px-6 pt-6 pb-6'>
        ...
        <div className='mb-6 pt-28 sm:pt-0 sm:pl-44 sm:min-h-[96px] sm:flex sm:flex-col sm:justify-center'>
